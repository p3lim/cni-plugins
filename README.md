...
- A [workflow](https://github.com/p3lim/cni-plugins/blob/master/.github/workflows/build.yml) watches for changes to the Dockerfile, which builds and pushes the image.
...
- [Permissive license](https://github.com/p3lim/cni-plugins/blob/master/LICENSE.txt) so anyone can take over maintenance should this repository become stale.
